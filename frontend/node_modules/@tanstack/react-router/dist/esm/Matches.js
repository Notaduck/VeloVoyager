...
function Match({ matchId }) {
  ...
  const ResolvedSuspenseBoundary = !route.isRoot && (route.options.wrapInSuspense ?? PendingComponent ?? ((_b = route.options.errorComponent) == null ? void 0 : _b.preload)) ? React.Suspense : SafeFragment;
