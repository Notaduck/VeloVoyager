...
export const file_activity_v1_activity: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp, file_google_protobuf_wrappers]);
...
/**
 * @generated from message activity.v1.UploadActivityImageRequest
 */
export type UploadActivityImageRequest = Message<"activity.v1.UploadActivityImageRequest"> & {
  /**
   * @generated from field: int32 activity_id = 1;
   */
  activityId: number;
...
/**
 * Describes the message activity.v1.UploadActivityImageRequest.
 * Use `create(UploadActivityImageRequestSchema)` to create a new message.
 */
export const UploadActivityImageRequestSchema: GenMessage<UploadActivityImageRequest> = /*@__PURE__*/
  messageDesc(file_activity_v1_activity, 12);

/**
 * @generated from message activity.v1.UploadActivityImageResponse
 */
export type UploadActivityImageResponse = Message<"activity.v1.UploadActivityImageResponse"> & {
  /**
   * @generated from field: string signed_put_url = 1;
   */
  signedPutUrl: string;
};

/**
 * Describes the message activity.v1.UploadActivityImageResponse.
 * Use `create(UploadActivityImageResponseSchema)` to create a new message.
 */
export const UploadActivityImageResponseSchema: GenMessage<UploadActivityImageResponse> = /*@__PURE__*/
...
export const ActivityService: GenService<{
  ...
  uploadActivityImage: {
    methodKind: "unary";
    input: typeof UploadActivityImageRequestSchema;
    output: typeof UploadActivityImageResponseSchema;
  },
}> = /*@__PURE__*/
